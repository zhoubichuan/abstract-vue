...
<div class="data-entity">
  <el-tabs class="content-tabs" v-model="activeName" @tab-click="handleClick">
    ...
    <el-tab-pane class="content-tabs-pane" label="功能配置" name="functionConfig">
      <function-config v-if="activeName === 'functionConfig'"></function-config>
    </el-tab-pane>
    ...
    <el-tab-pane class="content-tabs-pane" label="实例布局设置" name="instance">
      <user-info v-if="activeName === 'instance'"></user-info>
    </el-tab-pane>
    <el-tab-pane class="content-tabs-pane" label="使用情况" name="userInfo">
      <user-info v-if="activeName === 'userInfo'"></user-info>
    </el-tab-pane>
    <el-tab-pane class="content-tabs-pane" label="历史记录" name="historyRecord">
...
export default {
  ...
  methods: {
    ...
    handleInit () {
      ...
      this.$api.getTagDetail(this.pageData.data.id).then(res => {
