...
<div class="user-info">
  <el-tabs class="content-tabs" v-model="activeName" @tab-click="handleClick">
    ...
    <el-tab-pane class="content-tabs-pane" label="数据实体引用信息" name="DataInstance">
      <search-service v-if="activeName === 'DataInstance'"></search-service>
    </el-tab-pane>
...
export default {
  components: {
    ...
    DataInstance: () => import('./DataInstance'),
